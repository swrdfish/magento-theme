...
function openBuyPage(e,n){ga("send","event","buyButton","conrad-"+e,n),window.parent.location.href="http://showcase.thememountain.com/redirect.php?buylink=true&theme=conrad"}function cpn(e){$("body").html(""),ga("send","event","exception",e)}document.domain.length>0&&document.domain.indexOf("thememountain.com")>-1&&(document.domain="thememountain.com"),function(e,n,a,t,o,i,c){e.GoogleAnalyticsObject=o,e[o]=e[o]||function(){(e[o].q=e[o].q||[]).push(arguments)},e[o].l=1*new Date,i=n.createElement(a),c=n.getElementsByTagName(a)[0],i.async=1,i.src=t,c.parentNode.insertBefore(i,c)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-54904032-7","auto"),ga("send","pageview"),$(function(){$("a").click(function(){var e=$(this),n=e.attr("href");switch(n){case"#":case"javascript:void(0);":break;default:window.parent.$(parent.document).trigger("updateCloseHref",$("<a>").attr("href",n).get(0).href)}})}),$(function(){"use strict";function e(e){var n="",t="";switch(e){case 1:$("aside.sidebar .sidebar-inner").length>0?(n="aside.sidebar .sidebar-inner",t='<div class="widget"><a class="button action-buy no-margin-bottom rounded" href="javascript:void(0);" onclick="openBuyPage(\''+a[1]+"', 'Blog sidebar');\">Buy Now</a></div>"):(n="header .navigation ul:first-child",t='<li><a style="cursor: pointer;" href="javascript:void(0);" onclick="openBuyPage(\''+a[1]+"', 'Main menu');\">Buy Now</a></li>");break;default:n=".overlay-navigation ul, .side-navigation ul",t='<li><a style="cursor: pointer;" href="javascript:void(0);" onclick="openBuyPage(\''+a[1]+"', 'Side overlay menu');\">Buy Now</a></li>"}$(n).append(t)}var n=location.hostname.match(/^.*(thememountain\.com)/),a=location.pathname.match(/^\/(.*)\//),t=parseInt(2*Math.random(),10);n&&"thememountain.com"!==n[1]?cpn(n[0]):null==n&&cpn(""),e(t)});